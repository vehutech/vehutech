...
import { companyName, currentYear, services, shortBreif } from "../lib/data.ts";
      ...
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-gray-100 pt-8">
          ...
          <div className="mt-10 flex gap-4 items-center">
            <p className="text-xs rounded-sm">Developer:</p>
            <a
              target="_blank"
              className="text-xs text-primary p-1 rounded-sm" // Removed b-chart-3
